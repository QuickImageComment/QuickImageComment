	...
	namespace LibRawWrapper {
		namespace Native
		{
			public enum class ThumbnailFormat
			{
				...
				/// <summary>
				/// The thumbnail buffer contains a JPEG file (read from the RAW file "asis," without any manipulations performed on it).
				/// </summary>
				...
				/// </summary>
				/// <remarks>
				/// Toget this format instead of <see href="Bitmap">Bitmap</see> you need to set LIBRAW_PROCESSING_USE_PPM16_THUMBS in processing options.
				/// </remarks>
