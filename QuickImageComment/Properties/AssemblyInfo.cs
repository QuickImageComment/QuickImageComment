...
[assembly: AssemblyInformationalVersion(".44" + AssemblyInfo.VersionSuffix + AssemblyInfo.Platform + AssemblyInfo.Framework)]
...
class AssemblyInfo
{
    ...
    public const string VersionToCheck = "4.44";
